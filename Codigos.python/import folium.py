...
display_html = '''
<div id="display" style="position:fixed; bottom:0; left:0; background: white; padding: 10px; width: 100%;"></div>
'''
m.get_root().html.add_child(folium.Element(display_html))

# Salvar o mapa em um arquivo HTML
print("Salvando o mapa...")
m.save('mapa_interativo.html')
print("Mapa salvo como mapa_interativo2.html")
